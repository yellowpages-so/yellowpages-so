...
public function test_customer_cannot_cancel_already_closed_quote_request(): void
{
    $customer = User::query()->create([
        'public_id' => 'test-'.Str::ulid(),
        'status' => 'active',
    ...
    $business = Business::query()->create([
        'public_id' => (string) Str::ulid(),
        'legal_name' => 'Closed Cancel Test Limited',
        'trading_name' => 'Closed Cancel Test',
        'slug' => 'closed-cancel-test-'.Str::lower(Str::random(6)),
        'status' => 'published',
        'profile_completeness' => 100,
        'created_by' => $owner->id,
    ]);
    ...
    DB::table('leads.quote_requests')->insert([
        'id' => $quoteRequestId,
        'reference_no' => 'TEST-'.Str::upper(Str::random(8)),
        'title' => 'Closed cancellation test',
        'description' => 'Test request',
        'status' => 'closed',
        'customer_user_id' => $customer->id,
        'contact_name' => 'Test Customer',
